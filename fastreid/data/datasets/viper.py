        ...
        if not osp.exists(self.split_path):
            ...
            for _ in range(10):
                ...
                for pid, idx in enumerate(train_idxs):
                    ...
                    train.append([cam_a_img, pid, self.dataset_name+"_0"])
                    train.append([cam_b_img, pid, self.dataset_name+"_1"])
                ...
                for pid, idx in enumerate(test_idxs):
                    ...
                    cam_b_img = cam_b_imgs[idx]
                    pid = self.dataset_name + "_" + str(pid)
                    test_a.append([cam_a_img, pid, self.dataset_name+"_0"])
                    test_b.append([cam_b_img, pid, self.dataset_name+"_1"])
