...
class LRScheduler(HookBase):
    ...
    def after_epoch(self):
        ...
        #CHANGE Maybe a better implementation
        if isinstance(self._scheduler["lr_sched"], torch.optim.lr_scheduler.MultiStepLR):
            if next_epoch > self.trainer.delay_epochs:
