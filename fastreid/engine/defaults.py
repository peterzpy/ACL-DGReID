...
class DefaultTrainer(TrainerBase):
    ...
    def build_hooks(self):
        ...
        ret = [
            ...
            hooks.LRScheduler(self.optimizer_meta, self.scheduler_meta),
        ]
        ...
        def test_and_save_results():
            self._last_eval_results = self.test(self.cfg, self.model, self.epoch)
    ...
    def run_step(self):
        ...
        self.cnt = 0
        base_iter = 1 if self.iter else 10
    ...
    @classmethod
    def build_optimizer(cls, cfg, model, flag=None):
        """
        Returns:
        ...
        """
        return build_optimizer(cfg, model, flag=flag)
    ...
    def test(cls, cfg, model, epoch):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TESTS):
            ...
            try:
                ...
                continue
            results_i = inference_on_dataset(model, data_loader, evaluator, flip_test=cfg.TEST.FLIP.ENABLED, epoch=epoch)
...
for _attr in ["model", "data_loader", "optimizer", "optimizer_meta", "grad_scaler"]:
